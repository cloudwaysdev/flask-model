...
@click.group()
@click.option('-f', '--file', default=os.path.join(os.getcwd(), '.flaskenv'),
              type=click.Path(exists=True),
              help="Location of the .flaskenv file, defaults to .flaskenv file in current working directory.")
...
def cli(ctx, file, quote):
    ...
    '''This script is used to set, get or unset values from a .flaskenv file.'''
    ctx.obj = {}
    ctx.obj['FILE'] = file
    ctx.obj['QUOTE'] = quote
